	...
	<div class="ui container">
		<div id="title">
			<h2 class="ui teal image header">
				<i class="pencil alternate icon"></i>자유게시판 글쓰기
			</h2>
		</div>
		<form class="ui form" action="${conPath }/fBoardReply.do?pageNum=${param.pageNum}" method="post" enctype="multipart/form-data">
			<input type="hidden" name="fbGroup" value="${fBoardReplyView.fbGroup }">
			<input type="hidden" name="fbStep" value="${fBoardReplyView.fbStep }">
			<input type="hidden" name="fbIndent" value="${fBoardReplyView.fbIndent }">
