	...
	<div class="ui container">
		<div id="title">
			<h2 class="ui teal image header">
				<i class="edit icon"></i>상품수정
			</h2>
		</div>
		<form class="ui form" action="${conPath }/productModify.do" method="post" enctype="multipart/form-data">
			<input type="hidden" name="pNo" value="${product.pNo }">
			<input type="hidden" name="originalFilename" value="${product.pImg }">
			<div class="ui form">
				<div class="fields">
					<div class="eight wide field">
						<label>상품명</label>
						<input type="text" name="pName" value="${product.pName }" placeholder="상품명" required="required">
					</div>
					...
					<div class="two wide field">
						<label>가격(원)</label>
						<input type="text" name="pPrice" value="${product.pPrice }" maxlength="8" placeholder="원" required="required"
					...
					<div class="three wide field">
						...
						<label for="pImg">
							<div class="ui action input">
								<input type="text" id="filename" readonly="readonly" value="${product.pImg }">
			...
			<br>
			<input type="submit" value="수정하기" class="ui right floated primary button">
		</form>
	</div>
