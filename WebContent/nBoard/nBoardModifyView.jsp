	...
	<div class="ui container">
		<div id="title">
			<h2 class="ui teal image header">
				<i class="edit icon"></i>뉴스/정보 글수정
			</h2>
		</div>
		<form class="ui form" action="${conPath }/nBoardModify.do?pageNum=${param.pageNum}" method="post">
			<input type="hidden" name="nbNo" value="${nBoard.nbNo }">
			<div class="field">
				<label>제목</label> <input type="text" name="nbTitle"
					placeholder="제목" required="required" value="${nBoard.nbTitle }">
			</div>
